...
contract JointSavings {
    ...
    /*
    Inside the new contract we create the following variables:
    ...
    */
    ...
    /*
    Finally, I add the **default fallback function** so that the contract can store Ether sent from outside the deposit function.
    */
